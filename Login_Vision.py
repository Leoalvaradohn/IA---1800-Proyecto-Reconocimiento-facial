...
def registro_facial():
    ...
    while(True):
        ...
        cv2.imshow('Posicione su rostro dentro del recuadro',frame)         #Mostramos el video en pantalla
        if cv2.waitKey(1) == 13:            #Cuando oprimamos "Escape" rompe el video
            break
    ...
    contra_entrada.delete(0, END)
    Label(pantalla1, text = "Registro de Face ID Exitoso", fg = "green", font = ("Calibri",12)).pack()
...
def registro():
    ...
    pantalla1.geometry("400x250")  #Asignamos el tamaño de la ventana
    ...
    Label(pantalla1, text = "Registrar: debe ingresar usuario y contraseña.").pack()
    Label(pantalla1, text = "Face ID: debe de registrar un rostro.").pack()
    ...
    Button(pantalla1, text = "Face ID", width = 15, height = 1, command = registro_facial).pack()
...
def verificacion_login():
    ...
    if log_usuario in lista_archivos:   #Comparamos los archivos con el que nos interesa
        ...
        if log_contra in verificacion:
            ...
            Label(pantalla2, text = "Acceso concedido", fg = "green", font = ("Calibri",12)).pack()
        else:
            print("Contraseña incorrecta, ingrese de nuevo")
            Label(pantalla2, text = "Contraseña Incorrecta", fg = "red", font = ("Calibri",12)).pack()
    else:
        print("Usuario no encontrado")
        Label(pantalla2, text = "Usuario no encontrado", fg = "red", font = ("Calibri",12)).pack()
...
#------------------------------Vamos a capturar el rostro-----------------------------------------------------
   # Imagen a comparar
    ...
    def orb_sim(img1,img2):
        ...
        regiones_similares = [i for i in matches if i.distance < 79] #Extraemos las regiones similares en base a los puntos claves
        if len(matches) == 0:
            return 0
    ...
    if usuario_login+".jpg" in im_archivos:   #Comparamos los archivos con el que nos interesa
        ...
        if similitud >= 0.95:
            Label(pantalla2, text = "Bienvenido al sistema ", fg = "green", font = ("Calibri",11)).pack()
            print("Bienvenido al sistema usuario: ",usuario_login)
            print("Compatibilidad con la foto del registro: ",similitud)
        else:
            print("Rostro no identificado, ubique mejor su rostro")
            print("Compatibilidad: ",(similitud * 100))
            Label(pantalla2, text = "Rostro no reconocido", fg = "red", font = ("Calibri",11)).pack()
    else:
        print("Usuario no encontrado")
...
def login():
    ...
    pantalla2.title("Verificacion")
    pantalla2.geometry("600x720")   #Creamos la ventana
    Label(pantalla2, text = "Face ID: debe de asignar un rostro:").pack()
    Label(pantalla2, text = "Login: debe asignar usuario y contraseña:").pack()
    ...
    Label(pantalla2, text = "").pack()
    Button(pantalla2, text = "Face ID", width = 20, height = 1, command = login_facial).pack()
...
def pantalla_principal():
    ...
    pantalla = Tk()
    pantalla.geometry("600x400")  #Asignamos el tamaño de la ventana 
    pantalla.title("IA - Proyecto")       #Asignamos el titulo de la pantalla
...
#------------------------- Vamos a Crear los Botones ------------------------------------------------------
    ...
    Button(text = "Iniciar Sesion", height = "4", width = "30", command = login).pack()
    Label(text = "").pack() #Creamos el espacio entre el primer boton y el segundo boton
    Button(text = "Registro", height = "4", width = "30", command = registro).pack()
